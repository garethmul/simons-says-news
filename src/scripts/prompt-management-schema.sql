...
-- Additional prompt templates for new categories
INSERT IGNORE INTO ssnews_prompt_templates (name, description, category) VALUES
('Prayer Points Generator', 'Creates prayer points based on news articles and current events', 'prayer'),
('Image Search Query Generator', 'Generates search queries and alt text for finding relevant images', 'image_generation'),
('Daily Devotional Creator', 'Creates daily devotionals with scripture and reflection', 'devotional'),
('Newsletter Content Builder', 'Builds engaging newsletter content from multiple sources', 'newsletter'),
('Sermon Outline Generator', 'Creates sermon outlines and preaching notes', 'sermon'); 