...
const ContentReviewTab = ({
    ...
    filtered.sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case 'content_type':
          ...
          break;
        case 'source':
          comparison = (a.sourceArticle?.source_name || '').localeCompare(b.sourceArticle?.source_name || '');
          break;
        default:
          comparison = new Date(a.created_at) - new Date(b.created_at);
          break;
  ...
  }, [contentForReview, searchText, contentTypeFilter, sourceFilter, sortBy, sortDirection, currentPage]);
